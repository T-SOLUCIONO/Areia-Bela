...
export const translations = {
  en: {
    ...
    featureBadges: ['Sleeps 8', 'Private Heated Pool', 'Pet Friendly', 'Family Ready', 'Fast Wi-Fi'],
    availability: {
    ...
    footer: {
      description: 'Premium getaway near Madeira Beach with a heated pool, coffee bar, and self check-in for a smooth stay.',
      explore: 'Explore',
      reserve: 'Reserve',
      photos: 'Photos',
      services: 'Amenities',
  ...
  es: {
    ...
    featureBadges: ['Capacidad 8', 'Piscina climatizada', 'Acepta mascotas', 'Ideal para familias', 'Wi-Fi rapido'],
    availability: {
    ...
    footer: {
      description: 'Escapada premium junto a Madeira Beach con piscina climatizada, coffee bar y self check-in para viajar sin friccion.',
      explore: 'Explorar',
      reserve: 'Reservar',
      photos: 'Fotos',
      services: 'Servicios',
