...
> = {
  es: {
    ...
    expiry: 'El enlace vale por 15 minutos y se usa una sola vez.',
  ...
  en: {
    ...
    expiry: 'The link is good for 15 minutes and works once.',
  ...
  pt: {
    ...
    expiry: 'O link vale por 15 minutos e funciona uma única vez.',
  ...
  fr: {
    ...
    expiry: 'Le lien est valable 15 minutes et ne fonctionne qu’une fois.',
  ...
  de: {
    ...
    expiry: 'Der Link gilt 15 Minuten und funktioniert einmal.',
