...
export const translations = {
  en: {
    assistant: {
      launch: 'Ask about the house',
      title: 'Questions about the house',
      subtitle: 'Answers come from what the host has published here.',
      placeholder: 'Is the pool heated?',
      send: 'Send',
      thinking: 'Looking it up…',
      handoffLead: 'Angélica can confirm this one:',
      whatsapp: 'Message on WhatsApp',
      sms: 'Send a text',
      failed: 'That did not go through. Try again, or write to Angélica.',
      disclaimer: 'For dates and the exact price, use the calendar.',
      close: 'Close',
    },
    ui: {
  ...
  es: {
    assistant: {
      launch: 'Pregunta sobre la casa',
      title: 'Dudas sobre la casa',
      subtitle: 'Las respuestas salen de lo que la anfitriona ha publicado aquí.',
      placeholder: '¿La piscina es climatizada?',
      send: 'Enviar',
      thinking: 'Buscándolo…',
      handoffLead: 'Esto lo confirma mejor Angélica:',
      whatsapp: 'Escribir por WhatsApp',
      sms: 'Enviar un SMS',
      failed: 'No se pudo enviar. Inténtalo otra vez o escríbele a Angélica.',
      disclaimer: 'Para fechas y el precio exacto, usa el calendario.',
      close: 'Cerrar',
    },
    ui: {
  ...
  pt: {
    assistant: {
      launch: 'Pergunte sobre a casa',
      title: 'Dúvidas sobre a casa',
      subtitle: 'As respostas vêm do que a anfitriã publicou aqui.',
      placeholder: 'A piscina é aquecida?',
      send: 'Enviar',
      thinking: 'A procurar…',
      handoffLead: 'Isto a Angélica confirma melhor:',
      whatsapp: 'Escrever no WhatsApp',
      sms: 'Enviar uma SMS',
      failed: 'Não foi possível enviar. Tente novamente ou escreva à Angélica.',
      disclaimer: 'Para datas e o preço exato, use o calendário.',
      close: 'Fechar',
    },
    ui: {
      ...
      readReview: 'Ler a avaliação completa',
  ...
  fr: {
    assistant: {
      launch: 'Poser une question',
      title: 'Questions sur la maison',
      subtitle: "Les réponses viennent de ce que l'hôtesse a publié ici.",
      placeholder: 'La piscine est-elle chauffée ?',
      send: 'Envoyer',
      thinking: 'Recherche…',
      handoffLead: 'Angélica pourra mieux vous le confirmer :',
      whatsapp: 'Écrire sur WhatsApp',
      sms: 'Envoyer un SMS',
      failed: "L'envoi a échoué. Réessayez ou écrivez à Angélica.",
      disclaimer: 'Pour les dates et le prix exact, utilisez le calendrier.',
      close: 'Fermer',
    },
    ui: {
  ...
  de: {
    assistant: {
      launch: 'Frage zum Haus',
      title: 'Fragen zum Haus',
      subtitle: 'Die Antworten stammen aus dem, was die Gastgeberin hier veröffentlicht hat.',
      placeholder: 'Ist der Pool geheizt?',
      send: 'Senden',
      thinking: 'Wird nachgesehen…',
      handoffLead: 'Das kann Angélica besser bestätigen:',
      whatsapp: 'Auf WhatsApp schreiben',
      sms: 'SMS senden',
      failed: 'Das hat nicht funktioniert. Versuche es erneut oder schreibe Angélica.',
      disclaimer: 'Für Daten und den genauen Preis nutze den Kalender.',
      close: 'Schließen',
    },
    ui: {
      ...
      readReview: 'Ganze Bewertung lesen',
